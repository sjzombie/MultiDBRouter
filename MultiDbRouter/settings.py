"""
Django settings for MultiDbRouter project.
...
ROOT_URLCONF = 'MultiDbRouter.urls'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
                ...
                os.path.join(BASE_DIR, 'MultiDbRouter', 'templates'),
                ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'MultiDbRouter.wsgi.application'
